export default {
  ...
  learnerType: [
    ...
    { key: '3', text: '승인완료', value: 'Approved' },
    { key: '4', text: '반려(관리자 취소)', value: 'Rejected' },
    { key: '5', text: '수강취소(개인 취소)', value: 'Canceled' },
  ],
  ...
  // result management
  scoringState: [
    { key: '1', text: '채점하기', value: '채점하기' },
    { key: '2', text: '결과보기', value: '결과보기' },
  ],
  ...
  completionState: [
    { key: '1', text: '결과처리 대기', value: '결과처리 대기' },
    { key: '2', text: '이수', value: '이수' },
    { key: '3', text: '미이수', value: '미이수' },
    { key: '3', text: '불참', value: '불참' },
  ],

  searchPartForResultManagement: [
    { key: '1', text: '소속사', value: '소속사' },
    { key: '2', text: '소속 조직(팀)', value: '소속 조직(팀)' },
    { key: '3', text: '성명', value: '성명' },
  ...
  openedStateType: [
    { key: '1', text: '-전체-', value: 'All' },
    { key: '2', text: 'Opened', value: 'Opened' },
