    ...
    if (step === 1) {
      return (
        <div>
          ...
          <p>
            {getPolyglotText(
              '구성원의 ‘개인정보동의’ 작업을 재시행하게 되어 안내 드립니다.',
              'guide-TOS-배너2'
            )}
          </p>
        </div>
      ...
      return (
        <div>
          <h2>{getPolyglotText('개인정보동의', 'agreement-privacy-제목re')}</h2>
          <p>
            {getPolyglotText(
              'mySUNI 개인정보 처리방침에 동의해주세요.',
              'agreement-privacy-배너re'
            )}
          </p>
        </div>
      );
      ...
      return (
        <div>
          ...
          <p>
            {getPolyglotText(
              '여러분은 어떤 직무 분야에 해당하시나요?',
              'job-recent-배너1'
            )}
          </p>
          <p>
            {getPolyglotText(
              '수행하고 있는 업무를 기반으로 현 직무를 선택해주시기 바랍니다.',
              'job-recent-배너2'
            )}
          </p>
          <p>
      ...
      return (
        <div>
          ...
          <p>
            {getPolyglotText(
              '여러분의 관심사에 대해 꼼꼼하게 선택해주세요.',
              'college-favorite-배너1'
            )}
          </p>
          <p>
            {getPolyglotText(
              '최소 3개 이상으로 여러 개를 중복 선택 가능합니다 .',
              'college-favorite-배너2'
            )}
          </p>
          <p>
            {getPolyglotText(
              '조금이라도 관심을 가지는 주제는 모두 선택을 해주세요',
              'college-favorite-배너3'
            )}
          </p>
        </div>
      );
      ...
      return (
        <div>
          ...
          <p>
            {getPolyglotText(
              '여러분의 학습 목표와 선호하는 학습방식을 선택해 주세요.',
              'learning-learning-배너1'
            )}
          </p>
          <p>
            {getPolyglotText(
              'Survey Data를 참고하여 향후 보다 효과적이고 의미있는 콘텐츠를 제공해드릴 예정입니다.',
              'learning-learning-배너2'
            )}
          </p>
        </div>
      );
