      ...
      return (
        <div ref={this.contextRef}>
          ...
          <Segment className="full">
            <Segment className="bottom active tab full" data-tab="first">
              {/*좌측 contents*/}
              <ListContents />
            </Segment>
            <Segment className="bottom active tab full" data-tab="second">
              {/*우측 sub info*/}
              {/*<CubeRequired/>*/}
            ...
            <Segment className="bottom active tab full" data-tab="third">
              {/*우측 sub info*/}
              {/*<CubeEnrollment/>*/}
