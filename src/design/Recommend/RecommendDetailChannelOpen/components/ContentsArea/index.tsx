      ...
      <Segment className="full">
        <div className="recommend-detail">
          ...
          <div className="recommend-area">
            ...
            <div className="section-head">
              <span className="channel">혁신 Design</span> 채널에서 김유니님에게 추천하는 과정입니다.
              <div className="right">
                <Button icon className="right btn-blue">View all
                  <Icon className="morelink" />
                </Button>
            ...
            <div className="section-head">
              <span className="channel">DT</span> 채널에서 김유니님에게 추천하는 과정입니다.
              <div className="right">
                <Button icon className="right btn-blue">View all
                  <Icon className="morelink" />
                </Button>
            ...
            <div className="section-head">
              <span className="channel">Mgmt</span> 채널에서 김유니님에게 추천하는 과정입니다.
              <div className="right">
                <Button icon className="right btn-blue">View all
                  <Icon className="morelink" />
                </Button>
