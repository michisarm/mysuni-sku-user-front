...
class ReplyFormPage extends React.Component<Props> {
  ...
  routeToList() {
    ...
    this.props.history.push(
      routePaths.lectureCardOverviewPrev(collegeId, cubeId, lectureCardId)
    );
  }
    ...
    return (
      <ContentLayout
        ...
        breadcrumb={[
          ...
          {
            text: `Post`,
            path: `/lecture/college/${college.collegeId}/cube/${cubeId}/lecture-card/${lectureCardId}/posts/${postId}`,
          },
          { text: `Detail Reply` },
        ]}
      >
