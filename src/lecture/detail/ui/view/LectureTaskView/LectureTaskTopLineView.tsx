...
const LectureTaskTopLineView: React.FC<Props> =
  function LectureTaskTopLineView({
    totalCount,
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: getPolyglotText(
              '<span>총 <strong>{totalCount} 건</strong>의 게시글이 있습니다.</span>',
