  ...
  return (
    <>
      <Modal open={open} className="w1000 base linkedin">
        <Modal.Header>
          <PolyglotText
            defaultString="LinkedIn 최초 접속 시 학습 방법 안내"
            id="Collage-VideoLinkedIn-타이틀"
          />
        </Modal.Header>
        <Modal.Content>
                ...
                <ul className="txt-box">
                  ...
                  <li>
                    ...
                    <div className="text2">
                      <span className="red">
                        <PolyglotText
                          defaultString="최초 연결 이후에는 학습할 때 마다 별도 로그인 할 필요가 없습니다."
                          id="Collage-VideoLinkedIn-본문4"
                        />
                      </span>
                    </div>
                  </li>
                  <li>
                    <div className="text1">
                      <PolyglotText
                        defaultString="3. 기존에 개인이 보유하고 있는 ‘Linkedin 계정’과 ‘mySUNI 계정’을 연결하여 학습하고 싶은 경우"
                        id="Collage-VideoLinkedIn-본문5"
                      />
                    </div>
                    <div
                      className="text2"
                      dangerouslySetInnerHTML={{
                        __html: getPolyglotText(
                          `아래 표시된 <span className="red bold">③</span>번을 클릭후 개인이 보유한 Linkedin 계정의 ID/PW를 입력하면 됩니다.`,
                          'Collage-VideoLinkedIn-본문6'
                        ),
                      }}
                    />
                    <div
                  ...
                  <li>
                    <div className="text1">
                      <span className="bold">
                        <PolyglotText
                          defaultString="4. LinkedIn 학습사이트 정책으로 Internet Explorer는 더이상 지원하지 않습니다."
                          id="Collage-VideoLinkedIn-본문11"
                        />
                      </span>
                    </div>
                    <div className="text2">
                      <span className="red">
                        <PolyglotText
                          defaultString="지원 브라우저: Microsoft Edge/Chrome/Firefox/Safari(10.1.1 이상) 등을 이용해주세요."
                          id="Collage-VideoLinkedIn-본문12"
                        />
                      </span>
                    </div>
                  </li>
                ...
                <div className="img-box">
                  <ul>
                    <li>
                      ...
                      <div>
                        <PolyglotText
                          defaultString="상세화면에서 [학습하기] 버튼 클릭"
                          id="Collage-VideoLinkedIn-본문8"
                        />
                      </div>
                    ...
                    <li>
                      ...
                      <div>
                        <PolyglotText
                          defaultString="개인 계정과의 연동을 확인하는 팝업"
                          id="Collage-VideoLinkedIn-본문9"
                        />
                      </div>
                      <i className="arrow-popup-linkedin icon">
                        <span className="blind">next</span>
                    ...
                    <li>
                      ...
                      <div>
                        <PolyglotText
                          defaultString="재 확인하는 팝업"
                          id="Collage-VideoLinkedIn-본문10"
                        />
                      </div>
                    </li>
                  </ul>
