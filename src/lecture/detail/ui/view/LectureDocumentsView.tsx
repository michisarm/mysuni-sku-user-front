...
const LectureDocumentsView: React.FC<LectureDocumentsViewProps> =
  function LectureDocumentsView({ fileBoxId, learningState, params }) {
    ...
    const updateHeaderWidth = useCallback(() => {
      if (
        headerWidth &&
        headerWidth.current &&
        headerWidth.current.clientWidth
      ) {
