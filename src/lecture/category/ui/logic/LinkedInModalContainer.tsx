            ...
            <div className="content-wrap2">
              <div className="linkedin-cont">
                <ul className="txt-box">
                  ...
                  <li>
                    <div className="text1">2. 기존에 개인이 보유하고 있는 ‘Linkedin 계정’과 ‘mySUNI 계정’을 연결하지
                      않고 학습하고 싶은 경우,
                    </div>
                    <div className="text2">
                      <span className="bold">아래 표시된 </span>
                      <span className="red bold">①</span>번, <span className="red bold">②</span>번을 순서대로 클릭하시면,
                      <span className="bold"> ‘mySUNI계정’으로 학습</span>이 가능합니다.
                    </div>
                  ...
                  <li>
                    ...
                    <div className="text2">
                      LinkedIn 과정을 <span className="red">학습할 때 마다 개인 계정을 입력</span>하면,
                ...
                <div className="img-box">
                  <ul>
                    <li>
                      <Image src={`${process.env.PUBLIC_URL}/images/all/popup-img-linkedin-01.png`} alt="" />
                    ...
                    <li>
                      <Image src={`${process.env.PUBLIC_URL}/images/all/popup-img-linkedin-02.png`} alt="" />
                    ...
                    <li>
                      <Image src={`${process.env.PUBLIC_URL}/images/all/popup-img-linkedin-03.png`} alt="" />
                      <div>재 확인하는 팝업</div>
                    </li>
                  </ul>
                </div>
