...
@reactAutobind
class LinkedInModalContainer extends Component<Props, State> {
  //
  ...
  render() {
    ...
    return (
      <Modal open={open} className="w1000 base linkedin">
        <Modal.Header>LinkedIn 최초 접속 시 학습 방법 안내</Modal.Header>
        <Modal.Content>
            ...
            <div className="content-wrap2">
              <div className="linkedin-cont">
                <ul className="txt-box">
                  <li>
                    <div className="text1">
                      1. Linkedin 과정을 처음 학습하는 경우, 아래와 같이 기존에
                      개인이 보유하고 있는 ‘Linkedin 계정’과 연동하여 사용할
                      것인지를 확인하는 화면이 보여집니다.
                    </div>
                  </li>
                  <li>
                    <div className="text1">
                      2. 기존에 개인이 보유하고 있는 ‘Linkedin 계정’과 ‘mySUNI
                      계정’을 연결하지 않고 학습하고 싶은 경우,
                    </div>
                    <div className="text2">
                    ...
                    <div className="text2">
                      <span className="red">
                        최초 연결 이후에는 학습할 때 마다 별도 로그인 할 필요가
                        없습니다.
                      </span>
                    </div>
                  </li>
                  <li>
                    <div className="text1">
                      3. 기존에 개인이 보유하고 있는 ‘Linkedin 계정’과 ‘mySUNI
                      계정’을 연결하여 학습하고 싶은 경우
                    </div>
                    <div className="text2">
                      아래 표시된 <span className="red bold">③</span>번을 클릭후
                      개인이 보유한 Linkedin 계정의 ID/PW를 입력하면 됩니다.
                    </div>
                    <div className="text2">
                      LinkedIn 과정을{' '}
                      <span className="red">
                  ...
                  <li>
                    <div className="text1">
                      <span className="bold">
                        4. LinkedIn 학습사이트 정책으로 Internet Explorer는
                        더이상 지원하지 않습니다.
                      </span>
                    </div>
                    <div className="text2">
                      <span className="red">
                        지원 브라우저: Microsoft
                        Edge/Chrome/Firefox/Safari(10.1.1 이상) 등을
                        이용해주세요.
                      </span>
                    </div>
                  </li>
                ...
                <div className="img-box">
                  <ul>
                    <li>
                      <Image
                        src={`${process.env.PUBLIC_URL}/images/all/popup-img-linkedin-01.png`}
                        alt=""
                      />
                    ...
                    <li>
                      <Image
                        src={`${process.env.PUBLIC_URL}/images/all/popup-img-linkedin-02.png`}
                        alt=""
                      />
                    ...
                    <li>
                      <Image
                        src={`${process.env.PUBLIC_URL}/images/all/popup-img-linkedin-03.png`}
                        alt=""
                      />
                      <div>재 확인하는 팝업</div>
                    </li>
...
export default LinkedInModalContainer;
