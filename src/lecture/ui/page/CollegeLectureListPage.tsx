...
// import thumbnailImage from 'style/images/all/thumb-college-86-px.png';


@reactAutobind
class CollegeLectureListPage extends Component {
  //
  render() {
    return (
      <ContentLayout className="channel">
        <ContentHeader>
          <ContentHeader.Item className="thumb">
            <div>
              {/*<img src={thumbnailImage} alt="College thumbnail" />*/}
            </div>
          </ContentHeader.Item>
          <ContentHeader.Item className="title">
          ...
          <ContentHeader.Item className="btn-wrap">
...
export default CollegeLectureListPage;
