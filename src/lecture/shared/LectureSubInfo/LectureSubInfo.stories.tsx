...
export const Basic = () =>
  ...
  (
    <LectureSubInfo
      ...
      clazz={object('clazz', { learningTime: 0, participantCount: '1,250', cubeType: CubeType.ClassRoomLecture, passedStudentCount: 0, studentCount: 0 })}
...
export const WithState = () =>
  ...
  (
    <LectureSubInfo
      ...
      required={boolean('required', false)}
      level={select('level', storybookHelper.enumValues(LectureSubInfo.Level), LectureSubInfo.Level.Basic)}
      clazz={object('clazz', { learningTime: 750, participantCount: '1,250', cubeType: CubeType.ClassRoomLecture, passedStudentCount: 0, studentCount: 0 })}
      operator={object('operator', { email: 'univ@sk.com', name: '김수현', company: 'SK Telecom' })}
      onBookmark={() => alert('bookmark')}
    />
  );
...
export const WithClassCapacity = () =>
  ...
  (
    <LectureSubInfo
      clazz={object('clazz', { learningTime: 750, capacity: 240, participantCount: '1,250', cubeType: CubeType.ClassRoomLecture, passedStudentCount: 0, studentCount: 0 })}
      required={boolean('required', false)}
      level={select('level', storybookHelper.enumValues(LectureSubInfo.Level), LectureSubInfo.Level.Basic)}
      operator={object('operator', { email: 'univ@sk.com', name: '김수현', company: 'SK Telecom' })}
      onBookmark={() => alert('bookmark')}
