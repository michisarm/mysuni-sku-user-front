...
class EnrollingApi {
  ...
  baseUrl =
    ...
    process.env.REACT_APP_ARRANGE_API === undefined ||
    process.env.REACT_APP_ARRANGE_API === ''
      ? '/api/lecture/cards'
      : process.env.REACT_APP_ENROLLING_API;
  ...
  findEnrollingLectures(lectureFilterRdo: LectureFilterRdoModel) {
    ...
    return axiosApi
      .get<OffsetElementList<LectureModel>>(this.baseUrl + '/enrollingCards', {
        params,
      })
