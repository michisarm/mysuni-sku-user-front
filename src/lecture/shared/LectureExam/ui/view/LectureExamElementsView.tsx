  ...
  return (
    <div className="trs-box">
      ...
      <div className="btn-area">
        ...
        {
          !viewObject.surveyState && (viewObject.state === undefined || viewObject.state === 'InProgress' ||
        ...
        {
          !viewObject.surveyState && viewObject.state !== undefined && viewObject.state !== 'InProgress' && viewObject.state !== 'Waiting' && viewObject.state !== 'Missed' && (
