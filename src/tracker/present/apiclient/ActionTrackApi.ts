...
import { ActionTrackViewModel } from 'tracker/model/ActionTrackModel';
...
export function trackClick(actionTrackModel: ActionTrackViewModel) {
  const url = `${BASE_URL}/track/click`;
