    ...
    <>
      <div className="section-tit">
        <span className="text1">
          <PolyglotText
            defaultString="교육정보"
            id="Create-DetailContentsEdit-교육정보"
          />
        </span>
      </div>
      <Form.Field>
        <label>
          <PolyglotText
            defaultString="교육목표"
            id="Create-DetailContentsEdit-교육목표"
          />
        </label>
          ...
          >
            <span className="count">
              ...
              <span className="max">
                <PolyglotText
                  defaultString="500"
                  id="Create-DetailContentsEdit-교육목표Max500"
                />
              </span>
            </span>
            <textarea
              placeholder={getPolyglotText(
                ...
                'Create-DetailContentsEdit-교육목표Sub'
              )}
            ...
            <span className="validation">
              <PolyglotText
                ...
                id="Create-DetailContentsEdit-교육목표Max500Alert"
              />
            </span>
          </div>
        </div>
      ...
      <Form.Field>
        <label>
          <PolyglotText
            defaultString="교육대상"
            id="Create-DetailContentsEdit-교육대상"
          />
        </label>
        <div className="ui form">
          <div
          ...
          >
            <span className="count">
              ...
              <span className="max">
                <PolyglotText
                  defaultString="500"
                  id="Create-DetailContentsEdit-교육대상Max500"
                />
              </span>
            </span>
            <textarea
              placeholder={getPolyglotText(
                ...
                'Create-DetailContentsEdit-교육대상Sub'
              )}
            ...
            <span className="validation">
              <PolyglotText
                defaultString="You can enter up to 500 characters."
                id="Create-DetailContentsEdit-교육대상Max500Alert"
              />
            </span>
          </div>
        </div>
      ...
      <Form.Field>
        <label>
          <PolyglotText
            defaultString="교육내용"
            id="Create-DetailContentsEdit-교육내용"
          />
        </label>
        ...
        <div className="ui grid create create2">
          <div className="column">
            <label>
              <PolyglotText
                defaultString="이수조건"
                id="Create-DetailContentsEdit-이수조건"
              />
            </label>
          </div>
          <div className="column">
      ...
      <Form.Field>
        <label>
          <PolyglotText
            defaultString="기타안내"
            id="Create-DetailContentsEdit-기타안내"
          />
        </label>
        <div className="ui editor-wrap">
          <ReactQuill
        ...
        <div className="ui grid create create2">
          <div className="column">
            <label>
              <PolyglotText
                defaultString="교육시간"
                id="Create-DetailContentsEdit-교육시간"
              />
            </label>
          </div>
          <div className="column">
      ...
      <Form.Field>
        <label>
          <PolyglotText
            defaultString="난이도"
            id="Create-DetailContentsEdit-난이도"
          />
        </label>
