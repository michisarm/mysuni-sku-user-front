...
interface Props extends RouteComponentProps<{ cineroomId: string; aplType: string }> {
...
@observer
@reactAutobind
class CreateAplModelContainer extends React.Component<Props, States> {
  //
      ...
      Promise.resolve()
        ...
        .then(() => {
          this.props.history.push(
            `/my-training/learning/InProgress/pages/1`
          );
        })
        .then(() => {
...
export default withRouter(CreateAplModelContainer);
