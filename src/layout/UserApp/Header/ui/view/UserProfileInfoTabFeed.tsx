...
import { Modal, Table, Rating, Tab, Select, Comment, Accordion, Button, Icon, Image } from 'semantic-ui-react';
            ...
            <div className="sub-info-box">
              <div className="feed-list-area feed-wrapper">
                {feedData?.posts.map((item:any, index:any) => (
                  <UserProfileInfoTabFeedItem item={item} index={index} setOpen={props.setOpen} />
                ))}
              </div>
            </div>
          </div>
