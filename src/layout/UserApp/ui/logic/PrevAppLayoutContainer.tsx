...
@reactAutobind
@observer
class PrevAppLayoutContainer extends Component<Props> {
  //
  componentDidMount() {
    this.findProfile();
  }
  ...
  async findProfile() {
    ...
    if (obj != null && !obj.pisAgreement.signed) {
    ...
    } else if (obj != null && !obj.studySummaryConfigured) {
      window.location.href =
...
export default PrevAppLayoutContainer;
