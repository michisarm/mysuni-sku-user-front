  ...
  */
  ...
  routeToAplList() {
    ...
    if (sharedService && aplService) {
      ...
      aplService.changeAplQueryProps('type', apl.type || aplTypeUpper);
  ...
  async handleSave(mode?: string) {
    //
    const { apl, aplQuery } = this.props.aplService || ({} as AplService);
    ...
    */
    ...
    const toDateStart = moment(new Date())
      .startOf('day')
      .toDate()
      .getTime();
        ...
        <Container fluid>
          ...
          <div className="btn-group">
            ...
            <div className="fl-right">
              {((apl.state === AplState.OpenApproval || apl.state === null) && (
                <>
                  <Button
                    basic
...
export default withRouter(AplDetailPage);
