...
const TableHeaderColumn = {
  ...
  */
  InProgress: [
    ...
    { key: 5, text: getPolyglotText('학습시간', 'learning-학보드-hdhr'), icon: true },
    { key: 6, text: getPolyglotText('최근학습일', 'learning-학보드-hddt'), icon: true },
  ...
  InMyList: [
    ...
    { key: 5, text: getPolyglotText('학습시간', 'learning-관심목록-hdhr'), icon: true },
    { key: 6, text: getPolyglotText('최근학습일', 'learning-관심목록-hdlhr'), icon: true },
  ...
  Required: [
    ...
    { key: 5, text: getPolyglotText('학습시간', 'learning-권장과정-hdhr'), icon: true },
    { key: 6, text: getPolyglotText('최근학습일', 'learning-권장과정-hdlhr'), icon: true },
  ...
  Enrolled: [
    ...
    { key: 5, text: getPolyglotText('학습시간', 'learning-학습예정-hdhr'), icon: true },
    { key: 6, text: getPolyglotText('스탬프', 'learning-학습예정-hstp'), icon: true },
    { key: 7, text: getPolyglotText('학습시작일', 'learning-학습예정-h시작'), icon: true },
  ],
  Completed: [
    ...
    { key: 5, text: getPolyglotText('학습시간', 'learning-학완보드-hdhr'), icon: true },
    { key: 6, text: getPolyglotText('학습완료일', 'learning-학완보드-h완료'), icon: true },
  ],
  PersonalCompleted: [
    ...
    { key: 5, text: getPolyglotText('승인자 E-mail', 'learning-개인학습-h이메일') },
  ...
  Retry: [
    ...
    { key: 3, text: getPolyglotText('학습유형', 'learning-취소미이수-취소유형') },
    { key: 4, text: getPolyglotText('Level', 'learning-취소미이수-취소레벨') },
    { key: 5, text: getPolyglotText('학습시간', 'learning-취소미이수-취소시간'), icon: true },
    { key: 6, text: getPolyglotText('스탬프', 'learning-취소미이수-취소st'), icon: true },
    { key: 7, text: getPolyglotText('취소/미이수일', 'learning-취소미이수-취소dt'), icon: true },
  ],
  EarnedStampCount: [
    ...
    { key: 3, text: getPolyglotText('획득일자', 'mapg-msmp-헤더5'), icon: true },
    // 스탬프 인증서 보기
    // { key: 4, text: '수료증'},
  ],
  PersonalLearning: [
    ...
    { key: 6, text: getPolyglotText('생성자 E-mail', '승인관리-개인학습-헤더7') },
