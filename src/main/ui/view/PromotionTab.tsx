...
class PromotionTab extends Component {
  ...
  render() {
    ...
    return (
      <div data-area={AreaType.INTRODUCTION_PROMOTION} data-type={Type.CLICK}>
        <div className="ui attached active" data-tab="third">
          <div className="common-intro case3">
            <div className="mainVideoInner">
              ...
              <iframe
                className="fp-engine promotionVideo"
                src={`${link}`}
                title="player01"
                width="720px"
                height="400px"
            ...
            <div className="subVideo-inner">
              <div className="subVideo" onClick={() => this.videoChange(0)}>
                <img
                  className="subVideoThumbImg"
                  src={`${this.PUBLIC_URL}/images/all/promotion-palyer.png`}
                  alt="promotion-palyer"
                />
                ...
                <img
                  className="playIcon"
                  src={`${this.PUBLIC_URL}/images/all/play-icon.png`}
                  alt="play-icon"
                />
              </div>
              <div className="subVideo" onClick={() => this.videoChange(1)}>
                <img
                  className="subVideoThumbImg"
                  src={`${this.PUBLIC_URL}/images/all/promotion-palyer-02.png`}
                  alt="promotion-palyer-02"
                />
                <p className="subVideo-text">
                  {idx === 1 ? (
                    <a style={activeStyle}>
                ...
                <img
                  className="playIcon second"
                  src={`${this.PUBLIC_URL}/images/all/play-icon.png`}
                  alt="play-icon"
                />
              </div>
              <div className="subVideo" onClick={() => this.videoChange(2)}>
                <img
                  className="subVideoThumbImg"
                  src={`${this.PUBLIC_URL}/images/all/promotion-palyer-03.png`}
                  alt="promotion-palyer-03"
                />
                <p className="subVideo-text">
                  {idx === 2 ? (
                    <a style={activeStyle}>
                ...
                <img
                  className="playIcon third"
                  src={`${this.PUBLIC_URL}/images/all/play-icon.png`}
                  alt="play-icon"
                />
              </div>
              <div className="subVideo" onClick={() => this.videoChange(3)}>
                <img
                  className="subVideoThumbImg"
                  src={`${this.PUBLIC_URL}/images/all/promotion-palyer-04.png`}
                  alt="promotion-palyer-04"
                />
                <p className="subVideo-text">
                  {idx === 3 ? (
                    <a style={activeStyle}>
