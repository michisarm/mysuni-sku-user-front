  ...
  {learningObjectives && (
    <div className="main-stu-time">
      <span>
        ...
        {' '}
        <em>
          {learningObjectives.DailyLearningTimeHour}<PolyglotText defaultString="시간" id="home-Summary-dailyH" />
          {' '}
          {learningObjectives.DailyLearningTimeMinute}<PolyglotText defaultString="분" id="home-Summary-dailyM" />
          {' '}
        </em>
          <PolyglotText defaultString="학습, 일주일" id="home-Summary-daily" />
          {' '}
        <em>
          {learningObjectives.WeekAttendanceGoal}<PolyglotText defaultString="일" id="home-Summary-weekD" />
          {' '}
        </em>
