          ...
          <Modal.Content className="admin_popup_reject">
            <div className="personal-main-box">
              <span className="personal-des">
                <PolyglotText
                  defaultString="올해 학습 목표를 세워볼까요?"
                  id="home-학습목표-contents1"
                />
              </span>
              <Form>
            ...
            <div className="personal-main-box">
              <span className="personal-des">
                <PolyglotText
                  defaultString="일주일에 며칠 학습하실 건가요?"
                  id="home-학습목표-contents2"
                />
              </span>
              <Form>
            ...
            <div className="personal-main-box">
              <span className="personal-des">
                <PolyglotText
                  defaultString="하루 몇 시간 학습하실 건가요?"
                  id="home-학습목표-contents3"
                />
              </span>
              <Form>
                <Form.Field className="form-field3">
                  <div className="preview" style={{ overflow: 'visible' }}>
                    <Select
                      ...
                      onChange={(e: any, data: any) =>
                        handleInputChange('DailyLearningTimeHour', data.value)
                      }
                    />
                    <span>
                      <PolyglotText
                        defaultString="h"
                        id="home-학습목표-contents3h"
                      />
                    </span>
                    <Select
                      className="dropdown selection personal-popup-select"
                      ...
                      onChange={(e: any, data: any) =>
                        handleInputChange('DailyLearningTimeMinute', data.value)
                      }
                    />
                    <span>
                      <PolyglotText
                        defaultString="m"
                        id="home-학습목표-contents3m"
                      />
                    </span>
                  </div>
                </Form.Field>
