  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <Route exact path="/community/:communityId/member" component={MemberPage} />
        <Route exact path="/community/:communityId/member/group" component={MemberGroupPage} />
        <Route exact path="/community/:communityId/member/approve" component={MemberApprovePage} />
