...
} from 'community/service/useCommunityHome/requestCommunity';
                ...
                <>
                  {preview?.preview?.thumbnailId && (
                    <img
                      src={
                        preview?.preview &&
                        '/files/community/' + preview?.preview.thumbnailId
                      }
                    />
                  )}
                  {!preview?.preview?.thumbnailId && (
            ...
            <div className="home-card-container">
              <div className="home-card-title">
                ...
                <button className="ui icon button right btn-blue btn-more">
                  more
                  {/* <i aria-hidden="true" className="icon more3"></i> */}
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="commnuity-left-top">
          <div className="community-left-header">
            <span className="community-badge blue">
              {communityHome?.community?.fieldName}
            </span>
          ...
          <div className="community-home-left-span">
            <div className="community-user-info">
              <span>
                <img src={managerIcon} />
                <strong>{communityHome?.community?.managerName}</strong>
              </span>
              <span>
                멤버 <strong>{communityHome?.community?.memberCount}</strong>
              </span>
            </div>
