    ...
    <>
      ...
      {post.pinned === true && (
        ...
        >
          <span className="cell title">
            <span className="inner">
              {post.fileBoxId !== "null" && typeof post.fileBoxId !== null && (<img className="board-file" src="data:image/png;base64," />)}
              <span className="ellipsis">
                {post.title}
              </span>
              <span className="rep-num">
