...
import QnaManagementDetailPage from './ui/page/QnaManagementDetailPage';
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <Route
          exact
          path="/board/support/notice-detail/:postId"
          component={NoticeDetailPage}
        />
        <Route
          exact
          path="/board/support/faq-detail/:postId"
          component={FaqDetailPage}
        />
        <Route exact path="/board/support-qna" component={QnaRegisterPage} />
        <Route
          exact
          path="/board/support-qna/:sourceType/:sourceId"
          component={QnaRegisterPage}
        />
        <Route
          exact
          path="/board/support/qna-modify/:postId"
          component={QnaModifyPage}
        />
        <Route
          exact
          path="/board/support/qna-detail/:postId"
          component={QnaDetailPage}
        />
        <Route
          exact
          path="/board/support/answered-detail/:postId"
          component={AnswerDetailPage}
        />
        <Route
          exact
          path="/board/support/qna-management-detail/:qnaId"
          component={QnaManagementDetailPage}
        />
